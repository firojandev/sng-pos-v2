<x-core::layout
    title="ক্রয় ফেরত"
    title-en="Purchase Return"
    subtitle="সরবরাহকারীকে পণ্য ফেরত দিন"
    subtitle-en="Return stock back to the supplier"
    active="purchase"
>
    <div class="panel" style="margin-top:0; max-width:820px;">
        <div class="panel-head">
            <div>
                <div class="panel-title bn">ইনভয়েস #{{ $purchase->invoice_no }}</div>
                <div class="panel-title en" style="display:none;">Invoice #{{ $purchase->invoice_no }}</div>
            </div>
            <div>
                <span class="bn">সরবরাহকারী: </span><span class="en" style="display:none;">Supplier: </span>
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('purchase-returns.store', $purchase) }}">
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th class="bn">ক্রয়কৃত পরিমাণ</th><th class="en" style="display:none;">Purchased Qty</th>
                ...
                <div class="helper">
                    <span class="bn">শূন্য (০) পরিমাণের আইটেম বাদ দিয়ে জমা দিলে চলবে। বাকি থাকলে আগে তা থেকে সমন্বয় হবে, অতিরিক্ত অর্থ ক্যাশবক্সে প্রাপ্তি হিসেবে যোগ হবে।</span>
                    <span class="en" style="display:none;">Rows left at zero are skipped. The return first offsets any due balance; anything beyond that is logged as a cash refund received.</span>
                </div>
                ...
                <div style="display:flex; gap:10px; margin-top:20px; max-width:320px;">
                    ...
                    <a href="{{ route('purchase.ledger') }}" class="btn btn-outline" style="flex:1; justify-content:center;">
