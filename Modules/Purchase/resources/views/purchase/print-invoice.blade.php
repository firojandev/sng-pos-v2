...
<head>
    ...
    <title>ক্রয় ইনভয়েস - #{{ $purchase->invoice_no }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .purchase-invoice-sheet {
            max-width: {{ $isThermal ? $printerSetting->getCssPaperWidth() : ($printerSetting->isA5() ? '520px' : '700px') }} !important;
        }
...
<body>
    <div class="no-print">
        <div class="no-print-title">
            <span>ক্রয় ইনভয়েস স্লিপ প্রিভিউ</span>
        </div>
        <div class="btn-group">
