    ...
    <div class="panel" style="margin-top:0;">
        <div class="panel-body">
            <div class="section-row">
                ...
                <a class="btn btn-gold" href="{{ route('suppliers.create') }}">
                    ...
                    <span class="bn">নতুন সরবরাহকারী</span><span class="en">New Supplier</span>
                </a>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="row-avatar">
                                        <div class="av" style="background:var(--teal-800);">{{ mb_substr($supplier->name, 0, 1) }}</div>
                                ...
                                <td>
                                    <div class="row-actions">
                                        <a class="act" title="Edit" href="{{ route('suppliers.edit', $supplier) }}">
                                        ...
                                        <form method="POST" action="{{ route('suppliers.destroy', $supplier) }}" onsubmit="return confirm('এই সরবরাহকারীকে মুছে ফেলতে চান?');">
                                            @csrf
                                            @method('DELETE')
