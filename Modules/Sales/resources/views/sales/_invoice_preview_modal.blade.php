...
<div class="modal-backdrop" id="saleInvoicePreviewModal" style="z-index:1060;">
    <div class="modal-box" style="width:{{ $isThermal ? '500px' : ($printerSetting->isA5() ? '600px' : '760px') }}; max-width:96vw; max-height:94vh; padding:0; border-radius:12px; background:var(--card, #ffffff); border:1px solid var(--border, #e2e8f0); box-shadow:0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04); display:flex; flex-direction:column; overflow:hidden;">
        ...
        <div class="modal-head" style="padding:12px 20px; border-bottom:1px solid var(--border, #e2e8f0); display:flex; align-items:center; justify-content:space-between; background:var(--card, #ffffff);">
            <div style="display:flex; align-items:center; gap:8px;">
                ...
                <div>
                    <h3 style="font-size:16px; font-weight:700; color:var(--ink-900, #0f172a); margin:0; font-family:'Noto Sans Bengali', sans-serif;">
                        <span class="bn">ইনভয়েস প্রিভিউ</span>
                        <span class="en" style="display:none;">Invoice Preview</span>
                    </h3>
                </div>
            ...
            <x-core::button
                ...
                onclick="closeModal('saleInvoicePreviewModal')"
                ...
                <div class="thermal-receipt-sheet" id="saleThermalPreviewSheet" style="background:#ffffff; width:100%; max-width:{{ $printerSetting->getCssPaperWidth() }}; margin:0 auto; padding:10px 8px; color:#000000; font-family:'Noto Sans Bengali', monospace, sans-serif; font-size:{{ $isCompact58 ? '8.5px' : '10px' }}; line-height:1.35; box-sizing:border-box; box-shadow:0 2px 8px rgba(0,0,0,0.08); border:2px solid #cbd5e1; border-radius:6px;">
                    ...
                    <div style="font-size:{{ $isCompact58 ? '8px' : '9px' }}; line-height:1.4; margin-bottom:4px;">
                        <div style="display:flex; justify-content:space-between;">
                            <span>ইনভয়েস: <b id="sale-thermal-preview-invoice-no">—</b></span>
                            <span>তারিখ: <span id="sale-thermal-preview-date">—</span></span>
                        </div>
                        <div style="display:flex; justify-content:space-between;">
                            <span>গ্রাহক: <b id="sale-thermal-preview-customer-name">ওয়াক-ইন</b></span>
                            <span id="sale-thermal-preview-customer-phone-wrap" style="display:none;">মোবাইল: <span id="sale-thermal-preview-customer-phone">—</span></span>
                        </div>
                        <div id="sale-thermal-preview-customer-addr-wrap" style="display:none;">
                            ঠিকানা: <span id="sale-thermal-preview-customer-address">—</span>
                        </div>
                        <div>বিক্রেতা: <span id="sale-thermal-preview-seller-name">{{ auth()->user()?->name ?? 'অ্যাডমিন' }}</span></div>
                    </div>
                    ...
                    <table style="width:100% !important; border-collapse:collapse !important; margin:5px 0 !important; font-size:{{ $isCompact58 ? '8px' : '9.5px' }} !important;">
                        ...
                        <tbody id="sale-thermal-preview-items-body"></tbody>
                    </table>
                    ...
                    <div style="font-size:{{ $isCompact58 ? '8px' : '9.5px' }}; line-height:1.45;">
                        <div style="display:flex; justify-content:space-between;">
                            <span>সাব টোটাল:</span>
                            <span id="sale-thermal-preview-subtotal">৳০.০০</span>
                        </div>
                        <div id="sale-thermal-preview-product-discount-row" style="display:none; justify-content:space-between;">
                            <span>(-) পণ্য ছাড়:</span>
                            <span id="sale-thermal-preview-product-discount">৳০.০০</span>
                        </div>
                        <div id="sale-thermal-preview-discount-row" style="display:none; justify-content:space-between;">
                            <span>(-) ছাড়:</span>
                            <span id="sale-thermal-preview-discount">৳০.০০</span>
                        </div>
                        <div id="sale-thermal-preview-tax-row" style="display:none; justify-content:space-between;">
                            <span>(+) ভ্যাট:</span>
                            <span id="sale-thermal-preview-tax">৳০.০০</span>
                        </div>
                        <div id="sale-thermal-preview-delivery-row" style="display:none; justify-content:space-between;">
                            <span>(+) ডেলিভারি:</span>
                            <span id="sale-thermal-preview-delivery">৳০.০০</span>
                        </div>
                        <div id="sale-thermal-preview-adjustment-row" style="display:none; justify-content:space-between;">
                            <span id="sale-thermal-preview-adjustment-lbl">সমন্বয়:</span>
                            <span id="sale-thermal-preview-adjustment">৳০.০০</span>
                        </div>
                        ...
                        <div style="display:flex; justify-content:space-between; font-weight:700; font-size:{{ $isCompact58 ? '9.5px' : '11px' }};">
                            ...
                            <span id="sale-thermal-preview-grand-total">৳০.০০</span>
                        </div>
                        <div style="display:flex; justify-content:space-between;">
                            <span>পরিশোধ:</span>
                            <span id="sale-thermal-preview-paid">৳০.০০</span>
                        </div>
                        <div style="display:flex; justify-content:space-between; font-weight:600;">
                            <span>বর্তমান বাকি:</span>
                            <span id="sale-thermal-preview-due">৳০.০০</span>
                        </div>

                        <div id="sale-thermal-preview-due-box" style="display:none; margin-top:4px; border:1px dashed #000; padding:3px 4px;">
                            <div style="display:flex; justify-content:space-between;">
                                <span>পূর্বের বাকি:</span>
                                <span id="sale-thermal-preview-prev-due">৳০.০০</span>
                            </div>
                            <div style="display:flex; justify-content:space-between; font-weight:700;">
                                <span>মোট বকেয়া:</span>
                                <span id="sale-thermal-preview-total-due">৳০.০০</span>
                            </div>
                        </div>
                    </div>
            ...
            @else
                ...
                <div class="sale-invoice-sheet" id="saleStandardPreviewSheet" style="background:#ffffff; width:100%; max-width:{{ $printerSetting->isA5() ? '520px' : '680px' }}; margin:0 auto; padding:22px 26px; border:1px solid #e2e8f0; border-radius:4px; box-shadow:0 1px 4px rgba(0,0,0,0.06); color:#0f172a; font-family:'Noto Sans Bengali', sans-serif; box-sizing:border-box;">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; font-size:12px; line-height:1.6; margin-bottom:14px;">
                        <div style="width:50%;">
                            <div><b>ক্রেতার নাম :</b> <span id="sale-preview-customer-name">ওয়াক-ইন গ্রাহক</span></div>
                            <div><b>মোবাইল নং :</b> <span id="sale-preview-customer-phone">—</span></div>
                            <div><b>ঠিকানা :</b> <span id="sale-preview-customer-address">—</span></div>
                        </div>
                        <div style="width:50%; text-align:right;">
                            <div><b>বিক্রয় প্রতিনিধি :</b> <span id="sale-preview-seller-name">{{ auth()->user()?->name ?? 'অ্যাডমিন' }}</span></div>
                            <div><b>ইনভয়েস নং :</b> <span id="sale-preview-invoice-no" style="font-weight:700;">#স্বয়ংক্রিয়</span></div>
                            <div><b>তারিখ :</b> <span id="sale-preview-date">—</span></div>
                        </div>
                    </div>
                    ...
                    <table class="invoice-items-table" style="width:100% !important; border-collapse:separate !important; border-spacing:0 !important; border:1px solid #94a3b8 !important; margin:14px 0 !important; font-size:11.5px !important; table-layout:fixed !important;">
                        ...
                        <thead>
                            <tr style="background:#f8fafc;">
                                ...
                                <th style="border-right:1px solid #94a3b8 !important; border-bottom:1px solid #94a3b8 !important; padding:6px 2px; text-align:center; font-weight:700;">ইউনিট</th>
                                <th style="border-right:1px solid #94a3b8 !important; border-bottom:1px solid #94a3b8 !important; padding:6px 4px; text-align:center; font-weight:700;">ইউনিট মূল্য</th>
                                <th style="border-bottom:1px solid #94a3b8 !important; padding:6px 4px; text-align:center; font-weight:700;">মোট</th>
                            </tr>
                        </thead>
                        <tbody id="sale-preview-items-body"></tbody>
                        <tfoot>
                            <tr style="font-weight:700; background:#f8fafc;">
                                ...
                                <td style="border-right:1px solid #94a3b8 !important; border-top:1px solid #94a3b8 !important; padding:6px 2px; text-align:center; white-space:nowrap;" id="sale-preview-total-qty">
                                    ০.০০
                                </td>
                                ...
                                <td style="border-top:1px solid #94a3b8 !important; padding:6px 4px; text-align:right; white-space:nowrap;" id="sale-preview-table-subtotal">
                                    ০.০০
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    <table style="width:100%; border-collapse:collapse; margin-top:12px; font-size:12px; color:#0f172a;">
                        <tr>
                            ...
                            <td style="width:50%; vertical-align:top; padding-right:16px;">
                                <div id="sale-preview-due-box" style="display:none; margin-bottom:12px;">
                                    <table style="width:100%; max-width:230px; border-collapse:collapse; font-size:12px; line-height:1.5;">
                                        <tr>
                                            ...
                                            <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-prev-due">৳০.০০</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:2px 0; text-align:left;"><b>বর্তমান বাকি:</b></td>
                                            <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-current-due">৳০.০০</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:3px 0; text-align:right; font-weight:700; white-space:nowrap;" id="sale-preview-total-customer-due">৳০.০০</td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div style="margin-top:6px;">
                                    ...
                                    <div style="color:#1e293b; font-size:11.5px; line-height:1.4;" id="sale-preview-amount-words">
                                        শূন্য টাকা
                                    </div>
                                </div>
                                ...
                                <div style="margin-top:40px;">
                                    ...
                                    <div style="font-size:9.5px; color:#64748b; margin-top:3px;">
                                        প্রিন্ট করার সময়: <span id="sale-preview-print-time">—</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td style="width:50%; vertical-align:top; padding-left:16px;">
                                <table style="width:100%; border-collapse:collapse; font-size:12px; line-height:1.5;">
                                    <tr>
                                        ...
                                        <td style="padding:2px 0; text-align:right; font-weight:600; white-space:nowrap;" id="sale-preview-subtotal">৳০.০০</td>
                                    </tr>
                                    <tr id="sale-preview-product-discount-row" style="display:none;">
                                        <td style="padding:2px 0; text-align:left; color:#334155;">(-) পণ্য ছাড়</td>
                                        <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-product-discount">৳০.০০</td>
                                    </tr>
                                    <tr id="sale-preview-discount-row" style="display:none;">
                                        <td style="padding:2px 0; text-align:left; color:#334155;">(-) ছাড়</td>
                                        <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-discount">৳০.০০</td>
                                    </tr>
                                    <tr id="sale-preview-tax-row" style="display:none;">
                                        <td style="padding:2px 0; text-align:left; color:#334155;">ভ্যাট</td>
                                        <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-tax">৳০.০০</td>
                                    </tr>
                                    <tr id="sale-preview-delivery-row" style="display:none;">
                                        <td style="padding:2px 0; text-align:left; color:#334155;">ডেলিভারি</td>
                                        <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-delivery">৳০.০০</td>
                                    </tr>
                                    <tr id="sale-preview-adjustment-row" style="display:none;">
                                        <td style="padding:2px 0; text-align:left; color:#334155;" id="sale-preview-adjustment-lbl">সমন্বয়</td>
                                        <td style="padding:2px 0; text-align:right; white-space:nowrap;" id="sale-preview-adjustment">৳০.০০</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="border-top:1px solid #94a3b8; padding:0; height:1px;"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding:3px 0; text-align:right; font-weight:700; white-space:nowrap;" id="sale-preview-grand-total">৳০.০০</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:2px 0; text-align:left; color:#334155;">পরিশোধিত</td>
                                        <td style="padding:2px 0; text-align:right; font-weight:600; white-space:nowrap;" id="sale-preview-paid">৳০.০০</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:2px 0; text-align:left; color:#334155;">বাকি আছে</td>
                                        <td style="padding:2px 0; text-align:right; font-weight:600; white-space:nowrap;" id="sale-preview-due">
                                            ৳০.০০
                                        </td>
                                    </tr>
                                </table>
        ...
        {{-- Modal Footer: Back / Edit and Confirm / Make Sale Buttons --}}
        <div class="modal-foot" style="padding:10px 18px; background:var(--card, #ffffff); border-top:1px solid var(--border, #e2e8f0); display:flex; align-items:center; justify-content:space-between; gap:10px;">
            ...
            >
                <span class="bn">বিক্রয় সম্পন্ন করুন</span>
                <span class="en" style="display:none;">Make Sale</span>
            </x-core::button>
        </div>
    </div>
</div>
