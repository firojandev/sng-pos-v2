<x-core::layout
    title="বিক্রয়"
    title-en="Sales"
    subtitle="দোকানের বিক্রয় পরিচালনা করুন"
    subtitle-en="Manage your shop's sales"
    active="sales"
>
                    ...
                    <tbody>
                        @forelse ($sales as $sale)
                            <tr>
                                ...
                                <td>{{ $sale->customer->name ?? 'ওয়াক-ইন গ্রাহক' }}</td>
                                ...
                                <td>
                                    <div class="row-actions">
                                        <a class="act" title="Edit" href="{{ route('sales.edit', $sale) }}">
                                        ...
                                        <form method="POST" action="{{ route('sales.destroy', $sale) }}" onsubmit="return confirm('এই বিক্রয় মুছে ফেলতে চান? স্টক ফেরত যোগ হবে।');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="7"><div class="helper" style="margin-top:0;">কোনো বিক্রয় নেই</div></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
