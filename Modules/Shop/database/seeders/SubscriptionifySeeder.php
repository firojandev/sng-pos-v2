...
class SubscriptionifySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $toggleFeatures = [
            ...
            'report-sales-vat' => ['name' => 'বিক্রয় ভ্যাট রিপোর্ট (Sales VAT Report)', 'sort_order' => 25],
            'report-purchase' => ['name' => 'ক্রয় রিপোর্ট (Purchase Report)', 'sort_order' => 26],
            'report-stock' => ['name' => 'স্টক রিপোর্ট (Stock Report)', 'sort_order' => 27],
            'report-products' => ['name' => 'পণ্য রিপোর্ট (Product Report)', 'sort_order' => 28],
            'report-profit-loss' => ['name' => 'লাভ-ক্ষতি রিপোর্ট (Profit & Loss Report)', 'sort_order' => 29],
            'report-income' => ['name' => 'আয় রিপোর্ট (Income Report)', 'sort_order' => 30],
            'report-expense' => ['name' => 'ব্যয় রিপোর্ট (Expense Report)', 'sort_order' => 31],
            'report-financial-position' => ['name' => 'আর্থিক অবস্থান রিপোর্ট (Financial Position Report)', 'sort_order' => 32],
            'report-balance-sheet' => ['name' => 'ব্যালেন্স শীট (Balance Sheet)', 'sort_order' => 33],
            'audit' => ['name' => 'অ্যাক্টিভিটি লগ (Audit Log)', 'sort_order' => 34],
            'employees' => ['name' => 'কর্মচারী (Employees)', 'sort_order' => 35],
            'users' => ['name' => 'ইউজার (Users)', 'sort_order' => 36],
            'subscription' => ['name' => 'সাবস্ক্রিপশন ও প্ল্যান (Subscription & Plan)', 'sort_order' => 37],
        ];
        ...
        $plans = [
            ...
            [
                ...
                'toggles' => ['sales', 'purchase', 'cashbox', 'quick-sale', 'stock', 'products', 'branches', 'customers', 'suppliers', 'income', 'expense', 'accounts', 'account-transfers', 'tax', 'report-sales', 'report-sales-vat', 'report-purchase', 'report-stock', 'report-products', 'report-profit-loss', 'report-income', 'report-expense', 'report-financial-position', 'report-balance-sheet', 'audit', 'employees', 'users', 'subscription'],
            ],
            [
