...
class SubscriptionifySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $toggleFeatures = [
            ...
            'assets' => ['name' => 'সম্পদ (Assets)', 'sort_order' => 23],
            'debts' => ['name' => 'দেনা (Debts)', 'sort_order' => 24],
            'lend' => ['name' => 'ধার (পাওনা) (Lend)', 'sort_order' => 25],
            'security-money' => ['name' => 'জামানত (Security Money)', 'sort_order' => 26],
            'tax' => ['name' => 'ট্যাক্স ও ভ্যাট (Tax & VAT)', 'sort_order' => 27],
            'report-sales' => ['name' => 'বিক্রয় রিপোর্ট (Sales Report)', 'sort_order' => 28],
            'report-sales-vat' => ['name' => 'বিক্রয় ভ্যাট রিপোর্ট (Sales VAT Report)', 'sort_order' => 29],
            ...
            'report-balance-sheet' => ['name' => 'ব্যালেন্স শীট (Balance Sheet)', 'sort_order' => 37],
