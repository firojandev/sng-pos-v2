<x-core::button-group size="xs" aria-label="Asset Actions">
    @can('assets.edit')
        <x-core::button
            ...
            data-depreciation-type="{{ $asset->depreciation_type ?? 'flat' }}"
            data-depreciation="{{ $asset->depreciation ?? 0 }}"
            data-validity="{{ $asset->validity }}"
            data-validity-unit="{{ $asset->validity_unit ?? 'year' }}"
